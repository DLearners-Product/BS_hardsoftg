    ...
    public string GetActivityData(int levelno = -1){
        ...
        if(lessonGameActivityDatas[levelno].slideActivities != null){
            for(int i=0; i < lessonGameActivityDatas[levelno].slideActivities.Length; i++){
                // Debug.Log($"{lessonGameActivityDatas[levelno]}");
                // Debug.Log($"{lessonGameActivityDatas[levelno].slideActivities[i]}");
                // Debug.Log($"{lessonGameActivityDatas[levelno].slideActivities[i].getParsedJsonData()}");
